<x-layout title="Gestion de flotte pour transport de passagers - Topalma">
        ...
        <div class="mx-auto sm:px-4 xl:px-30">
            ...
            <div class="grid md:grid-cols-2 place-items-center gap-x-4 md:gap-y-15">
                ...
                <div class="p-5 content-center mb-15 md:mb-0">
                    <img src="{{ asset('img/tp2.jpg') }}" class="rounded" alt="">
                </div>

                <!-- Feature 3 -->
                <div class="p-5 content-center ">
                    <img src="{{ asset('img/tp4.webp') }}" class="rounded" alt="">
                </div>
                <!-- Feature 4 -->
    ...
    <x-sticky_bottom cible="au transport de passagers" />

    <!-- banner -->
    <div class="w-full">
        <img src="{{ asset('img/tp5.jpg') }}" class="bg-cover w-full" alt="">
    </div>
