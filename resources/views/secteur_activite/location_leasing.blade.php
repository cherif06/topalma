<x-layout title="Gestion de flotte pour le leasing et la location de véhicule - Topalma">

    <!-- Hero Section -->
    <div class="bg-zinc-900">
        <section class="w-full h-[600px] bg-center bg-no-repeat bg-cover sm:mask-l-from-90%" style="background-image: url({{ asset('img/bg5.jpg') }});">
        ...
        <div class="mx-auto sm:px-4 xl:px-30">
            ...
            <div class="grid md:grid-cols-2 place-items-center gap-x-4 md:gap-y-15">
                ...
                <div class="p-5 content-center mb-15 md:mb-0">
                    <img src="{{ asset('img/city_topview.jpg') }}" class="rounded " alt="">
                </div>

                <!-- Feature 3 -->
                <div class="p-5 content-center lg:px-10">
                    <img src="{{ asset('img/ll2.jpeg') }}" class="rounded" alt="">
                </div>
                <!-- Feature 4 -->
                ...
                <div class="p-5 content-center xl:px-[100px] mb-15 md:mb-0">
                    <img src="{{ asset('img/ll3.jpg') }}" class="rounded max-h-[500px] " alt="">
                </div>

                <!-- Feature 3 -->
                <div class="p-5 content-center lg:px-10">
                    <img src="{{ asset('img/ll4.jpg') }}" class="rounded" alt="">
                </div>
                <!-- Feature 4 -->
                <div class="p-5">
    ...
    <x-sticky_bottom cible="aux loueurs et leasers de véhicules" />

    <!-- banner -->
    <div class="w-full">
        <img src="{{ asset('img/fe4.jpg') }}" class="bg-cover w-full" alt="">
    </div>
