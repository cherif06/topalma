<x-layout title="Gestion de flotte pour les services et la maintenance - MobilisTrack">
    ...
    <div class="bg-zinc-900">
        <section class="w-full h-[600px] bg-center bg-no-repeat bg-cover sm:mask-l-from-90%" style="background-image: url({{ asset('img/sm1.jpg') }});">
        ...
        <div class="mx-auto sm:px-4 xl:px-32">
            ...
            <div class="grid md:grid-cols-2 place-items-center gap-x-4 md:gap-y-15">
                ...
                <div class="p-5 content-center mb-15 md:mb-0">
                    <img src="{{ asset('img/sm2.jpg') }}" class="rounded " alt="">
                </div>

                <!-- Feature 3 -->
                <div class="p-5 content-center ">
                    <img src="{{ asset('img/sm3.jpg') }}" class="rounded" alt="">
                </div>
                <!-- Feature 4 -->
                ...
                <!-- Feature 6 -->
                <div class="p-5 content-center mb-15 md:mb-0">
                    <img src="{{ asset('img/sm5.jpg') }}" class="rounded max-h-[500px] " alt="">
                </div>
    ...
    <x-sticky_bottom cible="aux entreprises de services et de maintenance" />

    <!-- banner -->
    <div class="w-full">
        <img src="{{ asset('img/sm6.jpg') }}" class="bg-cover w-full" alt="">
    </div>
