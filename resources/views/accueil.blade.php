...
<x-layout title="MobilisTrack - Digitalisez vos chantiers">
    ...
    <section class="w-full bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('img/bg1.jpg') }}');">        
        <div class="container mx-auto px-4 py-20 md:py-32">
            <div class="mx-auto text-white text-center text-shadow-lg/30">
                <h1 class="text-6xl md:text-8xl montserrat text-gray-50 font-extrabold mb-6 leading-tight">MobilisTrack</h1>
    ...
    <section class="pt-12">
        <div class="container text-center mx-auto space-y-6 lg:px-[150px] px-4">
            <p class="uppercase montserrat font-extrabold text-xl lg:text-3xl">Optimisez la gestion de votre flotte et réduisez vos coûts avec MobilisTrack</p>          
            <p class="text-lg font-grey">MobilisTrack est la solution de référence pour la <strong>géolocalisation</strong>, la <strong>gestion de flotte</strong> et l’<strong>optimisation des ressources</strong>.
    ...
    <section class="py-20 bg-slate-800">
        <div class="container mx-auto px-4 xl:px-32">
            <div class="flex flex-col md:flex-row gap-10 lg:gap-16">
                ...
                <div class="md:w-3/5">
                    <h3 class="text-2xl font-semibold mb-6 uppercase montserrat text-gray-50">Gérez, Suivez, sécurisez : Maîtrise de la Géolocalisation Intelligente avec MobilisTrack</h3>
                    <p class="text-md leading-7 mb-4 text-gray-50 ">
                        Bienvenue dans l’univers de la gestion opérationnelle redéfinie, où l’innovation rencontre la fiabilité. MobilisTrack
                    ...
                    <p class="text-md leading-7 text-gray-50 ">
                        Chez MobilisTrack, nous allions innovation et fiabilité pour offrir à votre entreprise les solutions les plus avancées en
                        ...
                        productivité de votre entreprise ou à sécuriser vos actifs précieux, MobilisTrack est là pour vous accompagner. Explorez
                        nos solutions sur mesure et découvrez comment nous pouvons transformer votre manière de gérer votre activité. Bienvenue
                        dans l’avenir de la gestion d’activité avec MobilisTrack.
                    </p>
            ...
            <div class="swiper">
                <div class="swiper-wrapper container">
                    <a href="Gestion-de-flotte-dentreprise" class="block swiper-slide shadow-lg/30">
                        <img src="{{ asset('img/sa1.jpg') }}" class="w-full h-48 object-cover" />
