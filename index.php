...
<head>
    ...
    <title>Topalma - Digitalisez vos chantiers</title>
...
<body class="bg-gray-50">
    ...
    <!-- Hero Section -->
    <section class="w-full bg-cover bg-center bg-no-repeat bg-[url('assets/img/bg1.jpg')]" style="background-image: url(assets/img/bg1.jpg);">        
        ...
        <div class="container mx-auto px-4 xl:px-20">
            <div class="flex flex-col md:flex-row gap-10 lg:gap-16">
                <div class="hidden md:w-2/5 md:flex justify-end">
                    <img src="assets/img/bg2.jpg" class="shadow-xl/30 rounded h-[600px] relative bottom-30" alt="">
                </div>
                <div class="md:w-3/5">
            ...
            <div class="swiper">
                <div class="swiper-wrapper w-full">
                    <a href="Gestion-de-flotte-dentreprise" class="block swiper-slide shadow-lg/30">
                        <img src="assets/img/sa1.jpg" class="w-full h-50 object-cover" />
